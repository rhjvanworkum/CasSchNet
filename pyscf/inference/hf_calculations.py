...
if __name__ == "__main__":
  model_path = '../../checkpoints/wigner_dist_2000_hamiltonian_moe.pt'
  n_mo = 36
  cutoff = 5.0

  base_dir = '/mnt/c/users/rhjva/imperial/fulvene/geometries/geom_scan_200/'
  split_file = '../../data/geom_scan_200.npz'
  output_dir = '/mnt/c/users/rhjva/imperial/fulvene/hf_calculations/experiments/wigner_dist_2000_geom_scan_hamiltonian_moe/'
